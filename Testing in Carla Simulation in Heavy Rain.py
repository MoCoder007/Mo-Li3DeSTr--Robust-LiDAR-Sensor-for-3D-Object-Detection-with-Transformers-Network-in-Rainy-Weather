...
world.set_weather(carla.WeatherParameters(
    cloudiness=100.0,  # Full cloud cover
    precipitation=100.0,  # Maximum precipitation to simulate severe heavy rain
    precipitation_deposits=100.0,  # Maximum precipitation deposits to simulate accumulated water
    wind_intensity=50.0,  # Strong wind to enhance the storm effect
    fog_density=100.0,  # Maximum fog density for low visibility
    wetness=100.0,  # Maximum wetness to simulate wet surfaces
    sun_azimuth_angle=0.0,  # Sun azimuth angle doesn't matter much in full cloud cover
    sun_altitude_angle=-90.0  # Sun below the horizon to simulate darkness
))
